...
class Fruit {
  ...
  static show = (name) => {
    ...
    if (fruit.length === 1) {
      ...
      throw Error("The fruit doesnt exist or there's duplications");
    }
  };
  ...
  destroy() {
    const deletedFruit = fruits.find((fruit) => fruit.name.toLowerCase() === 
  this.name.toLowerCase())
  if (deletedFruit) {
    const indec = indexOf(deletedFruit)
